...
export const MouseImageTrail = () => {
  return (
    ...
    >
      <section className="relative grid h-screen w-full place-content-center bg-white">
        <div className="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]"></div>
        <div className="text-center">
          <h2 className="text-4xl md:text-6xl font-bold uppercase text-black mb-4">
            WORK & PLAY
          </h2>
          <p className="flex items-center justify-center gap-2 text-lg font-medium text-gray-600 mb-8">
            <FiMousePointer />
